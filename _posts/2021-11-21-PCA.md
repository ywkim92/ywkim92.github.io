...
$\large X_{pca} = X_{std} \times \left[ \mathbf{q}_{1}  \mathbf{q}_{2} \right]$ where q1, q2 are the first two columns of eigenvectors $Q$.
...
$\large X_{pca} = X_{std} \times \left[ \mathbf{v}_{1}  \mathbf{v}_{2} \right]$ where v1, v2 are the first two columns of $V$.
