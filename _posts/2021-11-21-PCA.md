...
$\large \mathbf{X} = \begin{pmatrix} x_{1,1} & \cdots & x_{1,p} \\\ \vdots & \ddots & \vdots \\\ x_{n,1} & \cdots & x_{n,p} \end{pmatrix} $

$ \begin{pmatrix} X_1 & \cdots&X_p \end{pmatrix} {a}_{n\times p} _{n\times p}$ 
